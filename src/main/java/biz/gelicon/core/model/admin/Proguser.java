...
public class Proguser {
    ...
    @Size(max = 128, message = "web пароль пользователя должно содержать не более {max} символов")
    ...
    public Proguser(Integer progUserId, Integer statusId,
            String progUserName, String progUserFullName, String proguserWebPassword) {
        this.proguserId = progUserId;
        this.proguserGroupId = Progusergroup.EVERYONE;
        this.statusId = statusId;
        this.proguserName = progUserName;
